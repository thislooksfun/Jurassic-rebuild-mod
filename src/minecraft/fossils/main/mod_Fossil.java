...
import fossils.client.model.ModelBrachiosaurus;
import fossils.client.model.ModelCarno;
import fossils.client.model.ModelCompy;
import fossils.client.model.ModelCryo;
import fossils.client.model.ModelDryo;
import fossils.client.model.ModelNautilus;
import fossils.client.model.ModelOviraptor;
import fossils.client.model.ModelPlesiosaur;
import fossils.client.model.ModelPterosaurGround;
import fossils.client.model.ModelRaptor;
import fossils.client.model.ModelSpino;
import fossils.client.model.ModelStegosaurus;
import fossils.client.model.ModelTRex;
import fossils.client.model.ModelTriceratops;
import fossils.client.model.Modeldil;
import fossils.client.renderer.RenderBrachiosaurus;
import fossils.client.renderer.RenderCarno;
import fossils.client.renderer.RenderCompy;
import fossils.client.renderer.RenderCryo;
import fossils.client.renderer.RenderDinoEgg;
import fossils.client.renderer.RenderDryo;
import fossils.client.renderer.RenderMosasaurus;
import fossils.client.renderer.RenderNautilus;
import fossils.client.renderer.RenderOvi;
import fossils.client.renderer.RenderPlesiosaur;
import fossils.client.renderer.RenderPterosaur;
import fossils.client.renderer.RenderRaptor;
import fossils.client.renderer.RenderSpino;
import fossils.client.renderer.RenderStegosaurus;
import fossils.client.renderer.RenderTRex;
import fossils.client.renderer.RenderTriceratops;
import fossils.client.renderer.Renderdil;
import fossils.entity.EntityBrachiosaurus;
import fossils.entity.EntityCarno;
import fossils.entity.EntityCompy;
import fossils.entity.EntityCryo;
import fossils.entity.EntityDinoEgg;
import fossils.entity.EntityDinosaurce;
import fossils.entity.EntityDryo;
import fossils.entity.EntityMosasaurus;
import fossils.entity.EntityNautilus;
import fossils.entity.EntityOvi;
import fossils.entity.EntityPlesiosaur;
import fossils.entity.EntityPterosaur;
import fossils.entity.EntityRaptor;
import fossils.entity.EntitySpino;
...
public class mod_Fossil {
    ...
    public static final Item dinoEgg = new ItemAncientEgg(5000).setCreativeTab(CreativeTabs.tabDecorations).setUnlocalizedName("dinoEgg");
    ...
    public static Item ChickenSoup;
    public static Item ChickenEss = new ModSoup(5001, 2).setCreativeTab(CreativeTabs.tabFood).setUnlocalizedName("ChickenEss");
...
*/
    ...
    public void registingRenderer(){  
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityTriceratops.class, new RenderTriceratops(new ModelTriceratops(), 0.5F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(EntitySpino.class, new RenderSpino(new ModelSpino(), 0.5F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityPlesiosaur.class, new RenderPlesiosaur(new ModelPlesiosaur(), 0.5F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityDinoEgg.class, new RenderDinoEgg(0.5F));
       
        RenderingRegistry.instance().registerEntityRenderingHandler(Entitydil.class, new Renderdil(new Modeldil(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityCarno.class, new RenderCarno(new ModelCarno(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityBrachiosaurus.class, new RenderBrachiosaurus(new ModelBrachiosaurus(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityCompy.class, new RenderCompy(new ModelCompy(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityCryo.class, new RenderCryo(new ModelCryo(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityOvi.class, new RenderOvi(new ModelOviraptor(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(EntityDryo.class, new RenderDryo(new ModelDryo(), 0.5F));
    ...
    */
    private void registEntitys(){
    	int modEntityID=1;
    	EntityRegistry.registerModEntity(EntitySpino.class, "Spinosaurus", modEntityID++, this, 250, 5, true);
        ...
        EntityRegistry.registerModEntity(EntityCarno.class, "Carnotaurus", modEntityID++,this,250,5,true);
       

        EntityRegistry.registerModEntity(EntityBrachiosaurus.class, "Brachiosaurus", modEntityID++,this,250,5,true);
        EntityRegistry.registerModEntity(EntityCompy.class, "Compsagnathus", modEntityID++,this,250,5,true);
        
        EntityRegistry.registerModEntity(EntityCryo.class, "Crylophosaur", modEntityID++,this,250,5,true);
        
        EntityRegistry.registerModEntity(EntityDryo.class, "Drylosaur", modEntityID++,this,250,5,true);
        
        EntityRegistry.registerModEntity(EntityDinoEgg.class, "Dino Egg", modEntityID++,this,250,5,true);
        
        EntityRegistry.registerModEntity(EntityOvi.class, "Oviraptor", modEntityID++,this,250,5,true);
...
GameRegistry.addRecipe(new ItemStack(FeederIdle, 1), new Object[]{
            "XYX", "ZAB", "BBB", Character.valueOf('X'), Item.ingotIron, Character.valueOf('Y'), Block.glass, Character.valueOf('Z'), Block.woodenButton, Character.valueOf('A'), Item.bucketEmpty, Character.valueOf('B'), Block.stone
        });
...
GameRegistry.addRecipe(new ItemStack(ChickenEss, 8), new Object[]{
    ...
    private void smeltingSetup(){
        ...
        try{
            FurnaceRecipes.smelting().addSmelting(Ancientegg.itemID,new ItemStack(SJL), EnumDinoType.Nautilus.ordinal());
        }catch(Throwable e){}
    ...
    */
    ...
    public void load(FMLInitializationEvent event) {
    	if(FMLCommonHandler.instance().getSide().isClient()){
    		          	...
    		          	chickenSoup = new ModSoup(204, 2).setCreativeTab(CreativeTabs.tabFood).setUnlocalizedName("chickenSoup");
       ...
       //   registBlocks();       
         ...
         registerEntityEgg (EntityRaptor.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityTRex.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityMosasaurus.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntitySpino.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityPterosaur.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityCarno.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityCompy.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityCryo.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityDryo.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityTriceratops.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityBrachiosaurus.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityStegosaurus.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityPlesiosaur.class, 0xffffff, 0x000000); 
         
         registerEntityEgg (EntityOvi.class, 0xffffff, 0x000000); 
...
*/
    ...
    public void UpdateName(boolean Init) {
        ...
        LanguageRegistry.addName(this.ChickenEss, "Chicken Soup");
        short i=0;
    ...
    public static void UpdateLangProp()
    	...
    	try{
	    	Langfile=new File((fossils.main.mod_Fossil.class).getResource("/Fossillang/"+LastLangSetting+".lang").getFile());
    	}
        catch(Throwable e){
    ...
    private static void UTF8Reader(Properties properties,String LangName)
    	    throws IOException
    	    {
    	        BufferedReader bufferedreader = new BufferedReader(new InputStreamReader((fossils.main.mod_Fossil.class).getResourceAsStream((new StringBuilder()).append("/Fossillang/").append(LangName).append(".lang").toString()), "UTF-8"));
