...
public class DinoAIFishing extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
    	...
    	if (this.theEntity.getHunger()<huntLimit && this.rand.nextInt(100)<percentage) return true;
        return false;
    }
    ...
    {
    		Random randSeed=rand;    	
    	for (int i=0;i<=randSeed.nextInt(3);i++){
            EntityItem var13 = new EntityItem(this.theEntity.worldObj, this.theEntity.posX, this.theEntity.posY, this.theEntity.posZ);
            var13.setEntityItemStack(new ItemStack(Item.fishRaw));
