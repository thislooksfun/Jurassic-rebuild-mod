...
public class WaterDinoAISwimming extends EntityAIBase
{
    ...
    protected void controlSurfacing(){
        ...
        for (int var4 = 0; var4 < var1; ++var4)
        {
            ...
            AxisAlignedBB var9 = AxisAlignedBB.getAABBPool().getAABB(this.entity.boundingBox.minX, var5, this.entity.boundingBox.minZ, this.entity.boundingBox.maxX, var7, this.entity.boundingBox.maxZ);
