...
import fossils.entity.ai.DinoAIAvoidEntityWhenYoung;
...
public class EntitySpino extends EntityDinosaurce{
	...
	public EntitySpino(World world)
    {
        super(world);
	...
	public boolean interact(EntityPlayer entityplayer)
    {
		...
		if (!this.isTamed()){
			if (itemstack!=null){
				...
				if (itemstack.itemID==Item.beefRaw.itemID){
	...
	/*private TileEntity GetNearestTileEntity(int targetType,int range){
		...
		public EntityAnimal spawnBabyAnimal(EntityAnimal entityanimal) {
			return new EntitySpino(worldObj);
		}
