...
import fossils.entity.ai.DinoAILearnChest;
import fossils.entity.ai.DinoAIPickItem;
import fossils.entity.ai.DinoAIStarvation;
import fossils.entity.ai.DinoAITargetNonTamedExceptSelfClass;
...
public class EntityCarno extends EntityDinosaurce implements IHighIntellegent {
	...
	public EntityCarno(World world) {
		super(world);
	...
	public boolean interact(EntityPlayer entityplayer) {
		...
		if (itemstack != null) {
			...
			if (isTamed()) {
				if (itemstack.itemID == Item.porkRaw.itemID) {
	...
	public EntityAnimal spawnBabyAnimal(EntityAnimal entityanimal) {
		return new EntityCarno(worldObj);
	}
