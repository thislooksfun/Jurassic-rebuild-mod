...
public class EntityOvi extends EntityDinosaurce implements IHighIntellegent {
	...
	public boolean interact(EntityPlayer entityplayer) {
		...
		if (itemstack != null) {
			...
			if (isTamed()) {
				if (itemstack.itemID == Item.chickenRaw.itemID) {
