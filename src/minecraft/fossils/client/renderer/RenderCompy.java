...
public class RenderCompy extends RenderLiving
{
	...
	public RenderCompy(ModelBase modelbase, float f)
    {
        super(modelbase, f); 
    }
	...
	public void renderCow(EntityCompy entityRaptor, double d, double d1, double d2, 
            float f, float f1)
    {
		GL11.glPushMatrix();
        ...
        try
        {
             ...
             float var15 = entityRaptor.prevLimbYaw + (entityRaptor.limbYaw - entityRaptor.prevLimbYaw) * f1;
             float var16 = entityRaptor.limbSwing - entityRaptor.limbYaw * (1.0F - f1);
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2, 
            float f, float f1)
    {
        renderCow((EntityCompy)entityliving, d, d1, d2, f, f1);
    }

    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        renderCow((EntityCompy)entity, d, d1, d2, f, f1);
    }
	protected void renderEquippedItems(EntityLiving entityliving, float f)
    {
		float AgeOffset=(1.0F+0.0F*((float)((EntityDinosaurce)entityliving).getDinoAge()));
		ItemStack itemstack = ((EntityCompy)entityliving).ItemInMouth;
        if(itemstack != null)
        {
            GL11.glPushMatrix();
	...
	protected ResourceLocation func_110775_a(Entity entity) {
		...
		return new ResourceLocation("fossils:textures/mob/Compsognathus_Green.png");
	}
}