...
import fossils.client.model.ModelPTSLanding;
import fossils.client.model.ModelPterosaurFlying;
...
public class RenderPterosaur extends RenderLiving
{
            ...
            float f, float f1)
    {
        ...
        try
        {
            ...
            float f7 = entityPterosaur.prevLimbYaw+ (entityPterosaur.limbYaw - entityPterosaur.prevLimbYaw) * f1;
            float f8 = entityPterosaur.limbSwing - entityPterosaur.limbYaw * (1.0F - f1);
            if(f7 > 1.0F)
            {
                f7 = 1.0F;
            }
	...
	protected ResourceLocation func_110775_a(Entity entity) {
		...
		return new ResourceLocation("fossils:textures/mob/Pterosaur.png");
	}
}