...
public class RenderSpino extends RenderLiving
{
    ...
    public RenderSpino(ModelBase modelbase, float f)
    {
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2, 
            float f, float f1)
    {
        renderCow((EntitySpino)entityliving, d, d1, d2, f, f1);
    }

    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
    	if (((EntitySpino)entity).isWeak()) 
    		{
    			if (!(mainModel instanceof ModelSpino))mainModel=new ModelSpino();
    		}
    	else
    	{
    		if ((mainModel instanceof ModelSpino))mainModel=new ModelSpino();
    	}
        renderCow((EntitySpino)entity, d, d1, d2, f, f1);
    }
	@Override
	protected ResourceLocation func_110775_a(Entity entity) {
		// TODO Auto-generated method stubTRex
		return new ResourceLocation("fossils:textures/mob/Spino.png");
	}
}